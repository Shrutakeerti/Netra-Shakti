...
app = Flask(__name__,template_folder=r"D:\Diversion_2k25\eye_analysis\templates", static_folder=r"D:\Diversion_2k25\eye_analysis\static")
...
# Load models safely
checkpoint_inner = torch.load(r"D:\Diversion_2k25\eye_analysis\inner_eye_model.pth", map_location=device)
...
checkpoint_outer = torch.load(r"D:\Diversion_2k25\eye_analysis\outer_eye_model.pth", map_location=device)
